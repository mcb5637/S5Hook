...
function InstallS5Hook()
    ...
    local stage0     = "mhBhedohiianbcbnbcjfadbEceoicddmncppgagkCilfmcedafdlimmShgianboanboippQidmeIppnagbmcEA"
    local stage1     = "kapenpkbAiemahfclfafegkeagiAlageAgiAQeaAppVfiQhgAifmafihecmppVieShgAkdpanpkbAmgFpenpkbABgkDfdppVmmShgAfjfpileiElpAAkcAinhaIpdkeppQmd"
    local S5HookData = ""
